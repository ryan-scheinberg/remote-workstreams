...
Docs last updated: `docs-2026-07-10-4`

Docs audited through commit: `3dcd947`

This tag marks the last commit where `README.md` + `docs/` were audited/updated.

- View changes since docs were last updated: `git log docs-2026-07-10-4..HEAD --oneline`
- Diff docs vs current: `git diff docs-2026-07-10-4..HEAD -- README.md docs/`
