...
Docs last updated: `docs-2026-07-10`

Docs audited through commit: `4bd3939`

This tag marks the last commit where `README.md` + `docs/` were audited/updated.

- View changes since docs were last updated: `git log docs-2026-07-10..HEAD --oneline`
- Diff docs vs current: `git diff docs-2026-07-10..HEAD -- README.md docs/`
