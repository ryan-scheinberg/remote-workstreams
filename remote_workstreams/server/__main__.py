"""Composition root: `uv run python -m remote_workstreams.server`.
...
from remote_workstreams.server.logs import setup_logging
...
def _secret(name: str) -> str:
    ...
    if not value:
        ...
        raise RuntimeError(f"missing secret {name!r}: run /remote-workstreams:deploy or set ${env}")
    return value
