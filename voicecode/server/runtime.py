...
from voicecode.transcript import AssistantText, Entry, ToolActivity, UserText

logger = logging.getLogger("voicecode.server.runtime")
...
class ConvoBridge(Protocol):
    """The surface of voicecode.convo.ConvoBridge the server uses (the concrete
