---
description: Deploy voice-code on this Mac — Tailscale, provider keys into the Keychain, pairing token/PIN, launchd service, tailscale serve, pairing QR, round-trip test.
---
