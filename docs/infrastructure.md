...
The service runs the repository's locked dependencies with `uv`, starts the `voice` tmux session, and exposes `127.0.0.1:8400` through Tailscale Serve. No Docker, cloud database, public DNS record, or inbound router port is required.
